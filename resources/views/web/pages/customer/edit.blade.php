                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama" value="{{old('nama' , $customer->nama)}}">
                                @if ($errors->has('nama'))
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nomor" id="nomor" class="form-control" placeholder="Nomor" value="{{old('nomor' , $customer->nomor)}}">
                                @if ($errors->has('nomor'))
                            ...
                            <div class="mb-3">
                                ...
                                <select name="brand_id" id="brand_id" class="form-control">
                                    ...
                                    @foreach ($brands as $brand)
                                        <option value="{{$brand->id}}" {{$brand->id == $customer->brand_id ? 'selected' : ''}}>{{$brand->nama}}</option>
                                    @endforeach
                                </select>
